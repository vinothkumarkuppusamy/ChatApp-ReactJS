...
export default function ChatContainer() {
  ...
  return (
    <div>
        ...
        user ?
         ...
         <div style={{display:'flex', flexDirection:"row", justifyContent: 'space-between'}} >
          <h4 style={{color:"ButtonHighlight"}}>Username: {user}</h4>
          <strong style={{fontSize:"25px"}}>Super Chat Application </strong>
    ...
    <small style={{backgroundColor:'lightblue' , padding:5 , borderRadius:5,fontFamily:"cursive"}} > Chat, connect, repeat...  <strong> @16bc23@gmail.com</strong></small>
